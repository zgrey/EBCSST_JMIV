...
\textcolor{red}{PLACEHOLDER [ITEM 8, R2]: CONTINUED EMPHASIS ON CONCISION. CLEARLY DELINEATE WHICH RESULTS ARE FROM PRIOR WORK (G2AERO, GREY 2023) VERSUS NEW TO THIS MANUSCRIPT. R2 FOUND THIS DISTINCTION HARD TO IDENTIFY.}
...
\textcolor{red}{PLACEHOLDER: SHOULD WE ADD A NICE EXAMPLE CLUSTERING $(\boldsymbol{t},\boldsymbol{\ell})$ WITH MORPHOLOGICAL SEGMENTATION OF SUN DATA? PERHAPS A SHORT BLURB EMPHASIZING CLUSTERING COULD BE USEFUL HERE.}
