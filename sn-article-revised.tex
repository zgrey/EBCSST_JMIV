...
\textcolor{blue}{\begin{itemize}
    \item \textbf{[prior]}~\cite{grey2023separable} Shape polar standardization~\eqref{eq:SST} over $Gr(d,n)\times S^d_{++}$ (Section~\ref{subsec:SST}; supplementary derivations in Appendix~\ref{secA0}).
