...
\begin{figure*}
    ...
    \caption{\textcolor{red}{AUGMENT WITH ILLUSTRATIVE IMAGE OF THE TRANSFORMED OBJECTS} The SRQD of a translated (centered) curve where $W$ is a diagonal of quadrature weights $w_i$, $\boldsymbol{\tau}(s_i)$ are centered landmarks evaluated at quadrature nodes, and $\widetilde{\boldsymbol{v}}(s_i)$ are the $d$-tuples of evaluation functionals at quadrature nodes.}
    \label{fig:SRQD}
\end{figure*}
...
\begin{figure*}
    ...
    \caption{The diagram depicts various named spaces and essential transformations to map from translated curves to normal coordinates over a section of the product submanifold. Here, $\pi$ represents a normal projection on the first factor onto the equivalence classes of the Grassmannian. Dashed arrows indicate mappings into discrete representatives.}
