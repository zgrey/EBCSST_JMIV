...
\node[obj] (B1_lbl) at (0,-\rowsep-0.5cm) {\textrm{(preshape)}};
\node[obj] (B2) at (\colsep,-\rowsep)   {\nodeBotB};
\node[obj] (B2_lbl) at (\colsep,-\rowsep-0.5cm) {\textrm{(separable preshape)}};
\node[obj] (B3) at (2\colsep,-\rowsep)  {\nodeBotC};
\node[obj] (B3_lbl) at (2\colsep,-\rowsep-0.5cm) {\textrm{(separable shape)}};
\node[obj] (B4) at (3\colsep,-\rowsep)  {\nodeBotD};
\node[obj] (B4_lbl) at (3\colsep,-\rowsep-0.5cm) {\textrm{(normal coord.)}};
