...
Third, new blue-text comparisons contrast our approach with varifold-based methods~\cite{kaltenmark2017varifolds, pierson2022shape}, Sobolev metrics on curves~\cite{bauer2017sobolev}, and AI/deep-learning approaches~\cite{hartman2023varigrad, hartman2021supervised}. An undulation-versus-scale schematic figure remains in preparation for the next revision pass.
