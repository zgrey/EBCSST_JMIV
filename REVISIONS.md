...
5. [x] **[D] Revise abstract and add hypothesis-testing vs. clustering justification** (R1, R2, R4)
...
6. [~] **[W/D] Justify hypothesis testing as explainable binary classification** (R1, R2, R4)
...
7. [ ] **[D] Simplify notation in Sections 2--3 and add illustrative figures** (R1, R3, R4)
...
8. [ ] **[D] Restructure manuscript: foreground contributions, move background to supplement** (R2)
...
9. [ ] **[W] Discuss separability assumption; propose a diagnostic for violations** (R2)
...
10. [ ] **[W] Detail the MMD hypothesis-test procedure** (R1, R2, R4)
...
11. [ ] **[W] Add multiple-testing correction for joint product-MMD** (R2)
...
12. [ ] **[W] Provide guidelines for selecting r and n** (R2)
...
13. [ ] **[W] Replace random Procrustes template with Frechet mean or justify** (R1, R4)
...
14. [ ] **[N] Conduct simulated-data study for Type I error and power** (R1, R2)
...
15. [ ] **[N] Include a non-EBSD dataset or benchmark comparison** (R1, R4)
...
16. [ ] **[W/N] Demonstrate interpretability and compare with AI/varifold methods** (R4)
...
17. [ ] **[N] Report computational cost / runtime estimates per pipeline stage** (R1, R4)
